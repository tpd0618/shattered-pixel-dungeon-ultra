...
import com.shatteredpixel.shatteredpixeldungeonultra.effects.particles.EarthParticle;
...
import com.shatteredpixel.shatteredpixeldungeonultra.items.quest.MetalShard;
...
public class DM300 extends Mob {
	...
	public int attackProc(Char hero, int damage) {
		...
		if (enemy == Dungeon.hero && enemy.alignment != this.alignment && Random.Int(3) == 0){
			Buff.prolong(enemy, VioletCurse.class, VioletCurse.DURATION);
		}
		return damage;
	}
	...
	public void move(int step, boolean travelling) {
		...
		if (Dungeon.level.map[step] == Terrain.INACTIVE_TRAP && state == HUNTING) {
			...
			Buff.affect(this, Barrier.class).setShield( 100 + (HT - HP)/10);
