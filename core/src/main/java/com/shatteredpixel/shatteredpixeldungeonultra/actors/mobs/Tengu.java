...
import com.shatteredpixel.shatteredpixeldungeonultra.effects.Lightning;
import com.shatteredpixel.shatteredpixeldungeonultra.effects.Speck;
import com.shatteredpixel.shatteredpixeldungeonultra.effects.particles.BlastParticle;
import com.shatteredpixel.shatteredpixeldungeonultra.effects.particles.FlameParticle;
import com.shatteredpixel.shatteredpixeldungeonultra.effects.particles.SmokeParticle;
...
import com.shatteredpixel.shatteredpixeldungeonultra.items.TengusMask;
...
import com.shatteredpixel.shatteredpixeldungeonultra.sprites.MissileSprite;
import com.shatteredpixel.shatteredpixeldungeonultra.sprites.TenguSprite;
...
public class Tengu extends Mob {
	...
	public int attackProc(Char hero, int damage) {
		...
		if (enemy == Dungeon.hero && enemy.alignment != this.alignment && Random.Int(3) == 0){
			Buff.prolong(enemy, MissileWeaponNullify.class, MissileWeaponNullify.DURATION);
		}
		return damage;
	}
