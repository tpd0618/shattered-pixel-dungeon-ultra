...
import com.shatteredpixel.shatteredpixeldungeonultra.Bones;
import com.shatteredpixel.shatteredpixeldungeonultra.Dungeon;
import com.shatteredpixel.shatteredpixeldungeonultra.GamesInProgress;
import com.shatteredpixel.shatteredpixeldungeonultra.SPDSettings;
import com.shatteredpixel.shatteredpixeldungeonultra.ShatteredPixelDungeon;
...
import com.shatteredpixel.shatteredpixeldungeonultra.actors.blobs.SacrificialFire;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.AdrenalineSurge;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.Amok;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.AnkhInvulnerability;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.ArtifactRecharge;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.AscensionChallenge;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.Awareness;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.Barkskin;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.Barrier;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.Berserk;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.Bless;
...
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.Combo;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.Drowsy;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.Foresight;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.HoldFast;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.Hunger;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.Invisibility;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.Levitation;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.LostInventory;
...
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.Momentum;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.MonkEnergy;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.Paralysis;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.PhysicalEmpower;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.Recharging;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.Regeneration;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.SnipersMark;
...
import com.shatteredpixel.shatteredpixeldungeonultra.actors.mobs.Mimic;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.mobs.Mob;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.mobs.Monk;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.mobs.Snake;
...
import com.shatteredpixel.shatteredpixeldungeonultra.effects.CheckedCell;
...
import com.shatteredpixel.shatteredpixeldungeonultra.items.Amulet;
import com.shatteredpixel.shatteredpixeldungeonultra.items.Ankh;
import com.shatteredpixel.shatteredpixeldungeonultra.items.Dewdrop;
import com.shatteredpixel.shatteredpixeldungeonultra.items.EquipableItem;
import com.shatteredpixel.shatteredpixeldungeonultra.items.Heap;
import com.shatteredpixel.shatteredpixeldungeonultra.items.Heap.Type;
import com.shatteredpixel.shatteredpixeldungeonultra.items.Item;
import com.shatteredpixel.shatteredpixeldungeonultra.items.KindOfWeapon;
import com.shatteredpixel.shatteredpixeldungeonultra.items.armor.Armor;
import com.shatteredpixel.shatteredpixeldungeonultra.items.armor.ClassArmor;
import com.shatteredpixel.shatteredpixeldungeonultra.items.armor.glyphs.AntiMagic;
import com.shatteredpixel.shatteredpixeldungeonultra.items.armor.glyphs.Brimstone;
import com.shatteredpixel.shatteredpixeldungeonultra.items.armor.glyphs.Viscosity;
import com.shatteredpixel.shatteredpixeldungeonultra.items.artifacts.AlchemistsToolkit;
import com.shatteredpixel.shatteredpixeldungeonultra.items.artifacts.CapeOfThorns;
...
import com.shatteredpixel.shatteredpixeldungeonultra.items.bags.MagicalHolster;
import com.shatteredpixel.shatteredpixeldungeonultra.items.journal.Guidebook;
import com.shatteredpixel.shatteredpixeldungeonultra.items.keys.CrystalKey;
import com.shatteredpixel.shatteredpixeldungeonultra.items.keys.GoldenKey;
import com.shatteredpixel.shatteredpixeldungeonultra.items.keys.IronKey;
import com.shatteredpixel.shatteredpixeldungeonultra.items.keys.Key;
import com.shatteredpixel.shatteredpixeldungeonultra.items.keys.SkeletonKey;
...
import com.shatteredpixel.shatteredpixeldungeonultra.items.potions.elixirs.ElixirOfMight;
import com.shatteredpixel.shatteredpixeldungeonultra.items.potions.exotic.PotionOfDivineInspiration;
...
import com.shatteredpixel.shatteredpixeldungeonultra.items.scrolls.exotic.ScrollOfChallenge;
...
import com.shatteredpixel.shatteredpixeldungeonultra.journal.Document;
import com.shatteredpixel.shatteredpixeldungeonultra.journal.Notes;
import com.shatteredpixel.shatteredpixeldungeonultra.levels.Level;
import com.shatteredpixel.shatteredpixeldungeonultra.levels.Terrain;
import com.shatteredpixel.shatteredpixeldungeonultra.levels.features.Chasm;
import com.shatteredpixel.shatteredpixeldungeonultra.levels.features.LevelTransition;
import com.shatteredpixel.shatteredpixeldungeonultra.levels.traps.Trap;
import com.shatteredpixel.shatteredpixeldungeonultra.mechanics.ShadowCaster;
import com.shatteredpixel.shatteredpixeldungeonultra.messages.Messages;
import com.shatteredpixel.shatteredpixeldungeonultra.scenes.AlchemyScene;
...
import com.shatteredpixel.shatteredpixeldungeonultra.scenes.SurfaceScene;
import com.shatteredpixel.shatteredpixeldungeonultra.sprites.CharSprite;
import com.shatteredpixel.shatteredpixeldungeonultra.sprites.HeroSprite;
...
import com.shatteredpixel.shatteredpixeldungeonultra.ui.AttackIndicator;
import com.shatteredpixel.shatteredpixeldungeonultra.ui.BuffIndicator;
import com.shatteredpixel.shatteredpixeldungeonultra.ui.QuickSlotButton;
import com.shatteredpixel.shatteredpixeldungeonultra.ui.StatusPane;
import com.shatteredpixel.shatteredpixeldungeonultra.utils.GLog;
import com.shatteredpixel.shatteredpixeldungeonultra.windows.WndHero;
import com.shatteredpixel.shatteredpixeldungeonultra.windows.WndMessage;
import com.shatteredpixel.shatteredpixeldungeonultra.windows.WndOptions;
import com.shatteredpixel.shatteredpixeldungeonultra.windows.WndResurrect;
import com.shatteredpixel.shatteredpixeldungeonultra.windows.WndTradeItem;
...
public class Hero extends Char {
	...
	public int damageRoll() {
		...
		if (Dungeon.hero.buff(MissileWeaponNullify.class) != null && wep instanceof MissileWeapon){
			dmg = 1;
	...
	public int attackProc( final Char enemy, int damage ) {
		...
		if (Dungeon.hero.buff(SquareRootSnipe.class) != null && sqrt * sqrt == Dungeon.hero.HP){
			Dungeon.hero.damage(33, Warlock.class);
			if (!Dungeon.hero.isAlive()) {
				Dungeon.fail(Warlock.class);
				GLog.n( Messages.get(Warlock.class, "snipe") );
			}
		}
