...
import com.shatteredpixel.shatteredpixeldungeonultra.sprites.DM200Sprite;
...
public class DM200 extends Mob {
	...
	private void zap( ){
		...
		for (int i : trajectory.subPath(0, trajectory.dist)){
			GameScene.add(Blob.seed(i, 40, ToxicGas.class));
		}
		GameScene.add(Blob.seed(trajectory.collisionPos, 200, ToxicGas.class));
