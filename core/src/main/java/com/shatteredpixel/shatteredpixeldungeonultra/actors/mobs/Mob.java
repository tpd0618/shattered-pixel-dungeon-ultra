...
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.Sleep;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.SoulMark;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.Terror;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.VioletCurse;
...
import com.shatteredpixel.shatteredpixeldungeonultra.actors.mobs.npcs.DirectableAlly;
...
import com.shatteredpixel.shatteredpixeldungeonultra.effects.Surprise;
...
import com.shatteredpixel.shatteredpixeldungeonultra.items.weapon.missiles.darts.Dart;
...
public abstract class Mob extends Char {
	...
	public boolean isInvulnerable(Class effect) {
		return Dungeon.hero.buff(VioletCurse.class) != null && Dungeon.hero.justMoved;
	}
	...
	@Override
	public float speed() {
		return super.speed() * 1.5f * AscensionChallenge.enemySpeedModifier(this);
	}
