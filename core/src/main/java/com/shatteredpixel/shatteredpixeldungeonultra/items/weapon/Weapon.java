...
package com.shatteredpixel.shatteredpixeldungeonultra.items.weapon;
...
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.ExtremeConfusion;
import com.shatteredpixel.shatteredpixeldungeonultra.actors.buffs.MagicImmune;
...
abstract public class Weapon extends KindOfWeapon {
	...
	public Item upgrade() {
		if (this.level() > 4){
			GLog.w(Messages.get(Ring.class, "upgradefail"));
